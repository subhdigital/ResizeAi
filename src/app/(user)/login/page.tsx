...
function LoginForm() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            // Redirect to the intended page or dashboard on success
    ...
    return (
        ...
        >
                ...
                <div className="flex items-center justify-between">
                    <label className="flex items-center gap-3 cursor-pointer group">
                        <input
                            ...
                            className="w-5 h-5 rounded-lg border-slate-300 text-blue-600 focus:ring-blue-500/20 transition-all checked:bg-[#00d4ff]"
                        />
                        <span className="text-sm font-bold text-slate-500 group-hover:text-slate-700 transition-colors">Remember me</span>
                    </label>
                    <Link href="/forgot-password" style={{ fontSize: '0.875rem', fontWeight: 700, color: '#2563eb' }} className="hover:underline">
                        Forgot password?
                    </Link>
                </div>

                {/* Submit Button */}
                <button type="submit" disabled={loading} className="w-full py-4 text-white font-black text-lg rounded-2xl bg-[#00d4ff] shadow-[0_10px_30px_rgb(37,99,235,0.3)] hover:shadow-[0_20px_40px_rgb(37,99,235,0.5)] transition-all bg-[#00d4ff] hover:-translate-y-1 active:translate-y-0 disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            <p className="mt-8 text-center text-sm font-medium text-slate-500">
                ...
                <Link href="/register" style={{ fontWeight: 700, color: '#2563eb' }} className="hover:underline">
                    Sign up for free
                </Link>
            </p>
